...
type ProactiveStateRepository interface {
	...
	SaveProactiveGlobalMark(ctx context.Context, mark model.ProactiveGlobalMark) error
	FindProactiveGlobalMark(ctx context.Context, key string) (model.ProactiveGlobalMark, bool, error)
