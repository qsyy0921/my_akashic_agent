...
- 若前端需要更强队列或控制面审计可视化，再把 provider capability / control audit / control mutation policy detail 做成独立 dashboard 表格；当前 runtime overview 已提供 summary/card 级摘要，避免本轮扩大 UI 改造范围。
