# Phase 8.239 Review - Dashboard Inbox Metrics Table

## Completed

- runtime overview dashboard panel 已为 `inbox_metrics` card 增加结构化只读 drilldown。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.inbox_metrics_table=true`
