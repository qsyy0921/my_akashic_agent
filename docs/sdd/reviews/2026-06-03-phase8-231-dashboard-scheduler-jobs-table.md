# Phase 8.231 Review - Dashboard Scheduler Jobs Table

## Completed

- runtime overview dashboard panel 已为 `scheduler_jobs` card 增加结构化只读 drilldown。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.scheduler_jobs_table=true`
