# Phase 8.242 Review - Dashboard Observe Capture Table

## Completed

- runtime overview dashboard panel 已为 `observe_capture` card 增加结构化只读 drilldown。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.observe_capture_table=true`
