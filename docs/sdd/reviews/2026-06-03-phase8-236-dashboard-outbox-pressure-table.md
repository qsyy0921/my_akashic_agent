# Phase 8.236 Review - Dashboard Outbox Pressure Table

## Completed

- runtime overview dashboard panel 已为 `outbox_pressure` card 增加结构化只读 drilldown。
- runtime overview dashboard reader 已补齐 `outbox_pressure` 顶层透传。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.outbox_pressure_table=true`
