# Phase 8.235 Review - Dashboard Agent Job Pressure Table

## Completed

- runtime overview dashboard panel 已为 `agent_job_pressure` card 增加结构化只读 drilldown。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.agent_job_pressure_table=true`
