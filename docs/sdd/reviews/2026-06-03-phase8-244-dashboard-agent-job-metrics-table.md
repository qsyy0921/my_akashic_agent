# Phase 8.244 Review - Dashboard Agent Job Metrics Table

## Completed

- runtime overview dashboard panel 已为 `agent_job_metrics` card 增加结构化只读 drilldown。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.agent_job_metrics_table=true`
