# Phase 8.238 Review - Dashboard Send Ledger Metrics Table

## Completed

- runtime overview dashboard panel 已为 `send_ledger_metrics` card 增加结构化只读 drilldown。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.send_ledger_metrics_table=true`
