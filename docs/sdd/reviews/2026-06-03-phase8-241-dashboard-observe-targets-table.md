# Phase 8.241 Review - Dashboard Observe Targets Table

## Completed

- runtime overview dashboard panel 已为 `observe_targets` card 增加结构化只读 drilldown。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.observe_targets_table=true`
