# Phase 8.240 Review - Dashboard Inbound Dedupe Metrics Table

## Completed

- runtime overview dashboard panel 已为 `inbound_dedupe_metrics` card 增加结构化只读 drilldown。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.inbound_dedupe_metrics_table=true`
