# Phase 8.237 Review - Dashboard Outbox Metrics Table

## Completed

- runtime overview dashboard panel 已为 `outbox_metrics` card 增加结构化只读 drilldown。
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-go-migration-goal.ps1`
  - `dashboard_read_models.outbox_metrics_table=true`
