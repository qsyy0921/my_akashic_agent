...
def main() -> int:
    ...
    report = {
        ...
        "top1_accuracy": correct / len(results) if results else 0.0,
        "evidence_coverage": evidence_ok / len(results) if results else 0.0,
        "results": results,
    }
...
def _seed(store: SessionStore, fixture: dict, session_key: str) -> None:
    group_id = str(fixture["group_id"])
